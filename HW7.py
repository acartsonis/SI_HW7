...
# Your name: Adena Cartsonis
# Your student id:
# Your email: acartson@umich.edu
...
def position_birth_search(position, age, cur, conn):
       list = []
       year = 2023 - age
       cur.execute("SELECT Players.name, Players.birthyear FROM Players JOIN Positions ON Players.id = Positions.id WHERE Positions.position = ? AND Players.birthyear > ?", (position, year,))
       for row in cur.fetchall():
